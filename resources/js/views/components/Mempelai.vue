                ...
                <div class="lg:tw-w-4/5 lg:tw-mx-auto">
                    <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 sm:tw-gap-4 md:tw-gap-2 lg:tw-gap-6 tw-mx-auto">
                        <div class="tw-text-center">
                            ...
                            <h2 class="tw-py-3 m-name tw-text-1xl sm:tw-text-lg md:tw-text-1xl lg:tw-text-2xl">Dede Gunawan</h2>
                            <p class="tw-text-sm lg:tw-font-semibold tw-font-normal tw-mb-10">
                                Putra dari Bpk Jaya Umar<br>&<br>Ibu Maemunah
                            </p>
                        </div>
                        <div class="tw-text-center">
                            <div class="pw tw-mx-auto"></div>
                            <h2 class="tw-py-3 m-name tw-text-1xl sm:tw-text-lg md:tw-text-1xl lg:tw-text-2xl">Arini Alvin Hidayati</h2>
                            <p class="tw-text-sm lg:tw-font-semibold tw-font-normal tw-mb-12 sm:tw-mb-20">
                                Putri dari Bpk H. Aji Mustapa<br>&<br>Ibu Hj. Odijah / Hj. Ijong
                            </p>
                        </div>
                    </div>
                </div>
